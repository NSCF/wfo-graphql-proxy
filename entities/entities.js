// no specific logic / objects here, we just accept what we get from WFO
...
/**
 * @typedef  {Object} NameByIDQueryParams
 * @property {string} wfoid The WFO ID query parameter extracted from the URL
 */

/**
 * @typedef { Object } NameMatchQueryParams
 * @property {string} nameToMatch
 */

/**
 * @template T
 * @typedef {Object} GenericHttpRequest
 * @property {T} queryParams
 */

/**
 * @typedef {object} GenericWFOResponse
